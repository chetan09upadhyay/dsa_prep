...
import { BrainCircuit, Binary, TreePine, Box, List, ArrowLeftRight, Calculator, MessageSquare, Hash, ArrowRightLeft,Rocket,Layers, ListOrdered,ArrowUpDown } from "lucide-react"
    ...
    <div className="container py-8 max-w-7xl mx-auto">
      ...
      <div className="space-y-12">
        ...
        <section>
         ...
         {/* Sorting Section */}
        <section>
          <h2 className="text-2xl font-semibold mb-6">Sorting</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sections.sorting.map((app) => {
              const Icon = app.icon
              return (
