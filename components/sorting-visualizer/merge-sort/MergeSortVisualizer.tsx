...
import MergeSortOperation from "@/components/sorting-visualizer/merge-sort/mergeSortOperation" // Updated import
...
export function  MergeSortVisualizer({ content }: StackVisualizerProps) {
  // const { 
  //   stack,
  //   operations,
  //   isAnimating,
  ...
  return (
    <div className="container mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold tracking-tight">Merge Sort</h1>
      ...
      <Tabs defaultValue="visualization" className="w-full space-y-6">
        ...
        <TabsContent value="visualization" className="space-y-6">
              ...
              <MergeSortOperation /> {/* This should now work with the default import */}
