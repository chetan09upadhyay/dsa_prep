...
import {ArrowUpDown, 
  ListOrdered, 
  Layers, 
  Rocket , Binary, Home, Database, BrainCircuit, TreePine, List, SquareStack, SquareChevronLeft, Equal, MessageSquare, X, Hash, ArrowRightLeft } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
const sorting = [
  {
    name: "Bubble Sort",
    url: "/visualizer/bubblesort",
    icon: MessageSquare,
    description: "Repeatedly swaps adjacent elements to bubble up the largest values.",
  },
  {
    name: "Selection Sort",
    url: "/visualizer/selectionsort",
    icon: ArrowUpDown,
    description: "Selects the smallest element and places it in the sorted position.",
  },
  {
    name: "Insertion Sort",
    url: "/visualizer/insertionsort",
    icon: ListOrdered,
    description: "Builds the sorted array one element at a time by inserting in place.",
  },
  {
    name: "Merge Sort",
    url: "/visualizer/mergesort",
    icon: Layers,
    description: "Divides the array and merges sorted halves efficiently.",
  },
  {
    name: "Quick Sort",
    url: "/visualizer/quicksort",
    icon: Rocket,
    description: "Pivots and partitions the array for fast recursive sorting.",
  },
];
